...
| log_AuthorID | 作者ID |
| log_Tag | 文章标签 |
| log_Status | 文章或页面状态：0公开，1草稿，2审核 |
| log_type | 文章和页面类型：0文章，1页面 |
| log_Alias | 别名 |
| log_istop | 文章是否置顶：0不置顶，1全局置顶 |
| log_IsLock | 文章或页面是否允许评论：0允许，1禁止 |
| log_Title | 标题 |
| log_Intro | 摘要 |
| log_Content | 内容 |
| log_PostTime | 创建时间 |
